...
<body>
	...
	<div id="login">
		...
		<div class="container">
			<header>
			<h2><b>CFS &nbsp;system - Customer &nbsp;Login</b></h2>
			</header>
			<p>This Web is a Mutual Fund Web Application for customers to
				self-manage their accounts</p>
			<form method="post" action="${pageContext.request.contextPath}/customer/login.do">
				<div class="row half">
					<div class="6u">
						<input type="text" class="text2" name="username" value="${c.username}" placeholder="Username" />
					</div>
				</div>
				<div class="row half">
					<div class="6u">
				...
				<div class="row" style="margin-left: 405px;">
					<div class="6u">
						...
						Go to <a href="${pageContext.request.contextPath}/employee/admin.do">[ Employee Login ]</a>
					</div>
				</div>
			</form>
