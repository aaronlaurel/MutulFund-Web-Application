	...
	<section id="top" class="one">	
		...
		<div class="container">
			...
			<table border="1" id="table">
				...
				<c:forEach var="userFundVo" items="${UserFundVos}">
					<form method="post" action="${pageContext.request.contextPath}/customer/sell_fund_Detail_link.do?fund_id=${userFundVo.fund_id}">
						<tr>
							...
							<td style="text-align: right; padding-right: 15px;"><fmt:formatNumber pattern="#,##0.00">${1.0 * userFundVo.shares / 100000 * userFundVo.price}</fmt:formatNumber></td>
